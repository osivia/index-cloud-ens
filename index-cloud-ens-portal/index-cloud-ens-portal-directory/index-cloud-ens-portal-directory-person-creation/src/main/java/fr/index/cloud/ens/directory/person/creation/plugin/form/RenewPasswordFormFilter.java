...
/**
 * Filter : Check and renew the userpassword
 * @author Loïc Billon
 *
 */
@Component
public class RenewPasswordFormFilter implements FormFilter {

	public static final String IDENTIFIER = "RENEW_PASSWORD";
	...
	public void execute(FormFilterContext context, FormFilterExecutor executor)
		...
		service.renewPassword(context, executor);
