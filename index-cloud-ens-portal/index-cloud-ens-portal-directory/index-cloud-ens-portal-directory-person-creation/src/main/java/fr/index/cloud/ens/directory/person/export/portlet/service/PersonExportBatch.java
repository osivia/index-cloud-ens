...
public class PersonExportBatch extends AbstractBatch {
	...
	public void execute(Map<String, Object> parameters) throws PortalException {
		...
		PortalControllerContext portalControllerContext = new PortalControllerContext(portletContext, null, null);
			...
			try {
				...
				for (CMSBinaryContent content : contents) {
					...
					if (content.getFile() != null) {
						...
						// CRC
						CheckedInputStream checkedInputStream = new CheckedInputStream(content.getStream(),
								new CRC32());
						try {
							int i = -1;
