			...
			<form:form action="${addMessageUrl}" method="post" modelAttribute="detailForm"
				...
				<div class="offset-2  col-10 text-right">
					<div class="mt-2 d-flex">
						...
						<a href="#" onclick="$(this).closest('form').submit();" title="${title}"
							class="btn btn-link btn-link-hover-primary btn-sm my-auto ml-2 text-primary-dark no-ajax-link"> <i
							class="glyphicons glyphicons-basic-send"></i>
						</a>
					</div>
				</div>
			</form:form>
