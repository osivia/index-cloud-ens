...
public class MutualizedFileBrowserServiceImpl extends AbstractFileBrowserServiceImpl implements MutualizedFileBrowserService {
     ...
     */
    public static final List<String> SELECTOR_IDENTIFIERS = Arrays.asList(KEYWORDS_SELECTOR_ID, DOCUMENT_TYPES_SELECTOR_ID, LEVELS_SELECTOR_ID, SUBJECTS_SELECTOR_ID, COMPUTED_SIZE_SELECTOR_ID, COMPUTED_DATE_SELECTOR_ID, FORMATS_SELECTOR_ID);
