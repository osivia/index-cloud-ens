...
public class MutualizedFileBrowserController extends AbstractFileBrowserController {
     ...
     * @param page     page index request parameter
     */
    @ActionMapping("save-position")
    public void updateScrollPosition(ActionRequest request, ActionResponse response, @RequestParam("page") String page) throws PortletException {
        // Portal controller context
        PortalControllerContext portalControllerContext = new PortalControllerContext(this.portletContext, request, response);

        this.service.savePosition(portalControllerContext);
    }
    ...
    public void loadPage(ResourceRequest request, ResourceResponse response, @RequestParam("page") String page) throws PortletException, IOException {
        // Portal controller context
        PortalControllerContext portalControllerContext = new PortalControllerContext(this.portletContext, request, response);
        ...
        this.service.loadPage(portalControllerContext, NumberUtils.toInt(page));
    }
